...
const PostWidget = ({postId, postUserId, name, description, location, picturePath, userPicturePath, likes, comments}) => {
    ...
    const isLiked = Boolean(likes[loggedInUserId])      //Η isLiked γίνεται true/false ανάλογα με το αν ο χρήστης έχει κάνει ή όχι like στο συγκεκριμένο post
    const likeCount = Object.keys(likes).length     //Το πλήθος των likes για το συγκεκριμένο post
